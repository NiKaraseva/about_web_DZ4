...
$experience = [
    [
        "post" => "Подниматель пингвинов в арктике",
        "startDate" => "Сентябрь 2019",
        "endDate" => "Текущее время",
        "description" => "Лучшая работа на свете, ни на что её не променяю!",
    ],
    [
        "post" => "Главный инженер в SpaceX",
        "startDate" => "Июнь 2015",
        "endDate" => "Август 2018",
        "description" => "Запустила ракету в Космос ;)",
    ],
    [
        "post" => "Бариста в кофешопе",
        "startDate" => "Январь 2012",
        "endDate" => "Февраль 2013",
        "description" => "Варила кофе хорошим (и не очень) людям.",
    ],
];
?>
              ...
              <?php for ($i = 0; $i < count($experience); $i++): ?>
                <div class="w3-container>
                  ...
                  <?php echo $experience[$i]['startDate'];?> –
                    <?php if ($i == 0): ?>
                      <span class="w3-tag w3-teal w3-round"><?php echo $experience[$i]['endDate'];?>
                      </span>
                    <?php else: ?>
